module.exports = function(grunt) {
   ...
   grunt.initConfig({
		...
		uglify: {
			...
			target: {
				files: {'dist/js/core.min.js': ['src/plugin/jquery-1.12.4/jquery.min.js','src/plugin/bootstrap-3.3.7-dist/js/bootstrap.js','src/plugin/pace/pace.js','src/plugin/modernizr/modernizr-custom.js','src/plugin/fastclick/fastclick.js','src/js/skin.js','src/js/viber.js']}
			},
			target2: {
